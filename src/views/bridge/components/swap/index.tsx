                        ...
                        ['L1 > L2', 'L2 > L1'].map((item: string, index: number) => {
                            return (
                                <li key={index} className={`${state.transfer_msg!.transfer_type === index ? 'active-tab' : ''}`} onClick={async () => {
                                    const chain_id: number = item === 'L1 > L2' ? state.developer === 1 ? 16658437 : 2099156 : state.developer === 1 ? 10067275 : 8007736
                                    ...
                                    dispatch({
                                        ...
                                        payload: {
                                            transfer_msg: {
                                                from_chain: item === 'L1 > L2' ? state.developer === 1 ? 'Plian Testnet Main' : 'Plian Mainnet Main' : state.developer === 1 ? 'Plian Testnet Subchain 1' : 'Plian Mainnet Subchain 1',
                                                to_chain: item === 'L1 > L2' ? state.developer === 1 ? 'Plian Testnet Subchain 1' : 'Plian Mainnet Subchain 1' : state.developer === 1 ? 'Plian Testnet Main' : 'Plian Mainnet Main',
                                                transfer_type: index
                                            }
                                        }
                                    });
                    ...
                    selectedChain === 2099156 || selectedChain === 16658437
                        ...
                        : <div className="select-box">
                            ...
                            <Select
                                defaultValue="1"
                                options={[
                                    { value: '1', label: `${selectedChain === 2099156 ? 'Plian Mainnet Main' : 'Plian Testnet Main'}` },
                                ]}
                            />
                        </div>
                }
                    ...
                    selectedChain === 8007736 || selectedChain === 10067275
                        ...
                        : <div className="select-box">
                            ...
                            <Select
                                defaultValue="1"
                                options={[
                                    { value: '1', label: `${selectedChain === 8007736 ? 'Plian Mainnet Subchain 1' : 'Plian Testnet Subchain 1'}` },
                                ]}
                            />
                        </div>
                }
